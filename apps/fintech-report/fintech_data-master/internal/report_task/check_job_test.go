...
func TestNewCheckJobManager(t *testing.T) {
	type args struct {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			NewCheckJobManager(tt.args.historyService, tt.args.configService, tt.args.reportChecker, tt.args.reportConf)
		})
	}
}

func Test_checkJobManager_GetName(t *testing.T) {
	type fields struct {
		historyService history.TaskHistory
		configService  ConfigService
		reportChecker  ReportChecker
...
func Test_checkJobManager_ListJob(t *testing.T) {
...
func Test_checkJob_Do(t *testing.T) {
	ctrl := gomock.NewController(t)
	defer ctrl.Finish()
...
func Test_checkJob_GetLockName(t *testing.T) {
	type fields struct {
		reportTask    *fintech_data.ReportTask
		globalConf    *fintech_data.ReportGlobalConfig
		reportChecker ReportChecker
